...
def run():
    #crear una lista con solo los nombres de empleados que manejan 
    #usando comprehensions
    all_python_devs=[worker["name"] for worker in DATA if worker["language"]=="python"] 
    #lo mismo pero usando funciones superiores y anonimas
    ...
    #crear una lista con solos los nombres de empleados que trabajan en platzi
    #usando comprehensions
    ...
    #lista con todos los que tienen edad mayor a 18
    #usando funciones anonimas y de orden superior
    adults=list(filter(lambda worker: worker["age"]>18, DATA))
    adults=list(map(lambda worker: worker["name"], adults))
    #lo mismo pero usando comprehensions
